...
CREATE TABLE order_items (
    ...
    -- Foreign Keys for strict mapping
    CONSTRAINT fk_order_good FOREIGN KEY (good_product_id) REFERENCES products(id),
    CONSTRAINT fk_order_service FOREIGN KEY (service_product_id) REFERENCES products(id),
